...
public class JdbcTypeConverter extends ConverterAdapter<XmlAttributeValue> implements CustomReferenceConverter<XmlAttributeValue> {
    ...
    private class JdbcTypeContextReferenceSetResolver extends ContextReferenceSetResolver<XmlAttributeValue, PsiField> {
        ...
        @Override
        public @NotNull Optional<PsiField> resolve(@NotNull PsiField paramK, @NotNull String paramString) {
            return Optional.empty();
        }
