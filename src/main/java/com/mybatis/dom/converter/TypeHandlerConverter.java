...
import com.mybatis.reference.ContextReferenceSetResolver;
...
public class TypeHandlerConverter extends ConverterAdapter<XmlAttributeValue> implements CustomReferenceConverter<XmlAttributeValue> {
    ...
    private class JdbcTypeContextReferenceSetResolver extends ContextReferenceSetResolver<XmlAttributeValue, PsiClass> {
        ...
        @Override
        public @NotNull Optional<PsiClass> resolve(@NotNull PsiClass paramK, @NotNull String paramString) {
            return Optional.empty();
        }
